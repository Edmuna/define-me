            ...
            <div className="item3">
                <div className="word">
                    {wordNotFound ? (
                        ...
                        <div>
                            <div className="main__word">
                                <h1>{returnedData.word}</h1>
                            </div>
                            <div className="prononciation">
                                {returnedData.phonetic}
                            </div>
                        </div>
                    )}
                </div>
                ...
                >
                    <i
                        className={`fa-solid fa-${isSpeaking ? "pause" : "play"
                            } fa-2xl`}
                    ></i>
                </button>
            </div>
            ...
            <div className="item9">
                {!wordNotFound && (
                    <span>
                        Source:{" "}
                        <a
                            href={returnedData.sourceUrls}
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            {returnedData.sourceUrls}
                        </a>
                    </span>
                )}
            </div>
